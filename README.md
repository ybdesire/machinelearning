...
* [plot confusion matrix](3_matplotlib/plot_confusion_matrix.ipynb)
...
* [drop columns contains only zero](26_pandas/null_value/drop_columns_contains_only_zero.py)
...
* [sentiment analysis](9_NLP/sentiment_analysis.ipynb)
